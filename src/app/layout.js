                    ...
                    <div className="ft-grid-simple">
                      ...
                      <div className="ft-col">
                        ...
                        <p className="ft-brand-desc">
                          Votre boutique premium au Bénin &amp; en Afrique de l&apos;Ouest.
                          Paiement 100 % sécurisé et livraison express à votre porte.
                        </p>
                ...
                <div className="ft-payments">
                  <div className="container">
                    <div className="ft-pay-inner">
                      <span className="ft-pay-label">Paiements acceptés :</span>
                      <div className="ft-pay-tags">
                        ...
                        <span className="ft-pay-tag ft-pay-transfer">💸 Virement Direct</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="ft-bottom">
                  <div className="container">
                    <div className="ft-bottom-inner">
                      <span>© {new Date().getFullYear()} <strong>BAYA SHOP</strong> — Tous droits réservés.</span>
                      <span className="ft-bottom-credit">Conçu avec ❤️ par <strong>Albert BAYA</strong> · Bénin 🇧🇯</span>
                      <div className="ft-bottom-links">
                        <a href="#" className="ft-bottom-link">Confidentialité</a>
                        <span className="ft-bottom-sep">·</span>
                        <a href="#" className="ft-bottom-link">CGU</a>
                        <span className="ft-bottom-sep">·</span>
