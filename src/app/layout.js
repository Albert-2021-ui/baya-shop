              ...
              <CartProvider>
                ...
                <footer style={{ 
                  ...
                  <div className="container" style={{
                    ...
                    {/* Brand Column */}
                    <div>
                      <h2 style={{ color: 'var(--text-primary)', fontSize: '1.5rem', fontWeight: 800, marginBottom: '16px' }}>
                      ...
                      <div style={{ marginBottom: '24px' }}>
                        <h4 style={{ color: 'var(--text-primary)', fontSize: '0.9rem', marginBottom: '10px' }}>Inscrivez-vous à notre newsletter</h4>
                        <NewsletterForm />
                      </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                      <h3 style={{ color: 'var(--text-primary)', fontSize: '1.1rem', fontWeight: 600, marginBottom: '8px' }}>Navigation</h3>
                    ...
                    {/* Support Column */}
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                      <h3 style={{ color: 'var(--text-primary)', fontSize: '1.1rem', fontWeight: 600, marginBottom: '8px' }}>Support & Aide</h3>
                    ...
                    {/* Contact Info Column */}
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                      <h3 style={{ color: 'var(--text-primary)', fontSize: '1.1rem', fontWeight: 600, marginBottom: '8px' }}>Contact</h3>
                  ...
                  <div style={{ 
                    ...
                    <p>Conçu par <strong style={{ color: 'var(--text-primary)' }}>Albert BAYA</strong></p>
                  </div>
                </footer>
